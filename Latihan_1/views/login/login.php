...
<main class="form-signin w-100 m-auto">
  <form action="../../system/verification/verification.php" method="post">
    <!-- <img class="mb-4" src="../assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
    <span class="text-uppercase fs-4">Manajemen Inventori</span>
    <h1 class="h3 mb-3 mt-3 fw-normal">Silakan Login</h1>
    ...
    <p class="mt-5 mb-3 text-body-secondary">&copy; Bintang Atsal Faros XII RPL 1</p>
  </form>
</main>
