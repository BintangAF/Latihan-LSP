                            ...
                            <input type="hidden" name="act" value="insert">
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama_gudang" id="namaGudang" placeholder="Masukkan Nama Gudang" maxlength="30" required>

                                        <label class="form-label" for="lokasiGudang">Lokasi Gudang</label>
                                        <input type="text" class="form-control" name="lokasi_gudang" id="lokasiGudang" placeholder="Masukkan Lokasi Gudang" maxlength="30" required>
                                    </div>                                    
                                </div>                            
                        </div>
                    </div>
